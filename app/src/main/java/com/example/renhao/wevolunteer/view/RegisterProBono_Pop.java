...
import static com.example.renhao.wevolunteer.activity.RegisterProBonoActivity.PDactivity;

public class RegisterProBono_Pop extends PopupWindow {
    private Button btn_take_photo, btn_pick_photo, btn_cancel;
    private View mMenuView;


    public RegisterProBono_Pop(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.popupwindow_register_probono, null);
